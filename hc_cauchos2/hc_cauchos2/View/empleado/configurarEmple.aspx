        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="form-group">
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Inventario/engranaje.png"  Width="16px" />
                    <br />
                    Contraseña:
                    ...
                    <asp:Button ID="BTN_editarPass" runat="server" Text="Cambiar" class="btn btn-primary" ValidationGroup="grupopass" />
